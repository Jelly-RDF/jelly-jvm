...
final case class RdfStreamSubscribe(
    ...
    private def __computeSerializedSize(): _root_.scala.Int = {
      ...
      if (requestedOptions.isDefined) {
        ...
        __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.getSerializedSize) + __value.getSerializedSize
      };
      __size
    }
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      requestedOptions.foreach { __v =>
        ...
        _output__.writeUInt32NoTag(__m.getSerializedSize)
