...
|:-----------------------------------------------------------------------------------------------------------------------------------------------:|:----:|:-------------------------:|:-----------:|:-------------------------------------:|:-----------------------------------------------------------------------:|:-----------------------------------------------------:|
| [4.0.x](https://w3id.org/jelly/jelly-jvm/4.0.x)–[**{{ jvm_package_version() }}**](https://w3id.org/jelly/jelly-jvm/{{ jvm_package_version() }}) | 21+  |      3.3.x (LTS)[^2]      | 4.3.x–5.x.x |              5.4.x–6.x.x              |                               1.1.x–1.2.x                               | {{ neo4j_version('min') }}–{{ neo4j_version('max') }} |
