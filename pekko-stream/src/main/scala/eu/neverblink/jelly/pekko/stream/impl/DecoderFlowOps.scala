...
/** Flow operations for decoding Jelly streams. Factored out into a trait to allow other libraries
  * to implement their own nice Jelly parsing API.
  */
trait DecoderFlowOps:

  // *** Public API ***

  /** Decode the incoming [[RdfStreamFrame]]s as a Jelly stream of physical type TRIPLES. If the
    * stream is not a TRIPLES stream, the decoding will fail.
    *
    * @return
    *   intermediate builder object for further configuration
    */
  final def decodeTriples: DecoderIngestFlowOps.TriplesIngestFlowOps.type =
    DecoderIngestFlowOps.TriplesIngestFlowOps

  /** Decode the incoming [[RdfStreamFrame]]s as a Jelly stream of physical type QUADS. If the
    * stream is not a QUADS stream, the decoding will fail.
    *
    * @return
    *   intermediate builder object for further configuration
    */
  final def decodeQuads: DecoderIngestFlowOps.QuadsIngestFlowOps.type =
    DecoderIngestFlowOps.QuadsIngestFlowOps

  /** Decode the incoming [[RdfStreamFrame]]s as a Jelly stream of physical type GRAPHS. If the
    * stream is not a GRAPHS stream, the decoding will fail.
    *
    * @return
    *   intermediate builder object for further configuration
    */
  final def decodeGraphs: DecoderIngestFlowOps.GraphsIngestFlowOps.type =
    DecoderIngestFlowOps.GraphsIngestFlowOps

  /** Decode the incoming [[RdfStreamFrame]]s as a Jelly stream of any physical type. The type of
    * RDF statements is determined by the stream type specified in the stream options header. The
    * stream must have a set stream type (UNSPECIFIED is not allowed) and the stream type must not
    * change during the stream.
    *
    * @return
    *   intermediate builder object for further configuration
    */
  final def decodeAny: DecoderIngestFlowOps.AnyIngestFlowOps.type =
    DecoderIngestFlowOps.AnyIngestFlowOps

  /** Snoop the incoming stream for stream options and extract them to the materialized value.
    *
    * @return
    *   the materialized value is a future that will return the stream options when first
    *   encountered, or when the stream completes.
    */
  final def snoopStreamOptions
      : Flow[RdfStreamFrame, RdfStreamFrame, Future[Option[RdfStreamOptions]]] =
  ...
  private sealed trait DecoderIngestFlowOps:
    protected final inline def s(
        strict: Boolean,
        logicalType: LogicalStreamType,
    ): Option[LogicalStreamType] =
  ...
  private[DecoderFlowOps] object DecoderIngestFlowOps:
    case object TriplesIngestFlowOps
        extends DecoderIngestFlowOps,
          InterpretableAs.FlatTripleStream,
          InterpretableAs.GraphStream:

      /** @inheritdoc */
      override def asFlatTripleStream[TNode, TDatatype, TTriple](
    ...
    /** Flow operations for decoding Jelly streams of physical type QUADS.
      */
    case object QuadsIngestFlowOps
        extends DecoderIngestFlowOps,
      ...
      /** @inheritdoc */
      override def asDatasetStreamOfQuads[TNode, TDatatype, TQuad](
          supportedOptions: RdfStreamOptions,
      )(using
          converterFactory: JellyConverterFactory[
            TNode,
    ...
    /** Flow operations for decoding Jelly streams of physical type GRAPHS.
      */
    case object GraphsIngestFlowOps
        extends DecoderIngestFlowOps,
          InterpretableAs.FlatQuadStream,
          InterpretableAs.DatasetStreamOfQuads,
      ...
      /** @inheritdoc */
      override def asNamedGraphStream[TNode, TDatatype, TTriple](
          supportedOptions: RdfStreamOptions,
      )(using
          converterFactory: JellyConverterFactory[
            TNode,
    ...
    /** Flow operations for decoding Jelly streams of any physical type.
      */
    case object AnyIngestFlowOps extends DecoderIngestFlowOps, InterpretableAs.AnyStream:

      /** @inheritdoc */
      override def asGroupedStream[TNode, TDatatype, TTriple, TQuad](
          supportedOptions: RdfStreamOptions,
      )(using
          converterFactory: JellyConverterFactory[
            TNode,
      ...
      /** @inheritdoc */
      override def asFlatStream[TNode, TDatatype, TTriple, TQuad](
          supportedOptions: RdfStreamOptions,
      )(using
          converterFactory: JellyConverterFactory[
            TNode,
  ...
  private object InterpretableAs:
    trait FlatTripleStream:
      /** Interpret the incoming stream as a flat RDF triple stream from RDF-STaX.
        ...
        *   Type of graph node.
        * @tparam TDatatype
        *   Datatype in RDF stream.
        * @tparam TTriple
        *   Type of triple statements.
        * @return
        *   Pekko Streams flow
        */
      final def asFlatTripleStreamStrict[TNode, TDatatype, TTriple](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
        ...
        asFlatTripleStream(
          JellyOptions.DEFAULT_SUPPORTED_OPTIONS.clone.setLogicalType(
      ...
      /** Interpret the incoming stream as a flat RDF triple stream from RDF-STaX.
        *
        * This method will not check the logical stream type of the incoming stream. Use
        * .asFlatTripleStreamStrict if you want to check this.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asFlatTripleStream[TNode, TDatatype, TTriple](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as a flat RDF triple stream from RDF-STaX.
        ...
        *   Options to be supported by the decoder. Use ConvertedFactory.defaultSupportedOptions to
        *   get the default options and modify them as needed.
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        *   Type of graph node.
        ...
        *   Pekko Streams flow
        */
      def asFlatTripleStream[TNode, TDatatype, TTriple](supportedOptions: RdfStreamOptions)(using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
    ...
    trait FlatQuadStream:
      /** Interpret the incoming stream as a flat RDF quad stream from RDF-STaX.
        *
        * The incoming stream must have its logical type set to FLAT_QUADS or its subtype, otherwise
        * the decoding will fail. To allow for any logical type, use .asFlatQuadStream.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asFlatQuadStreamStrict[TNode, TDatatype, TQuad](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
        ...
        asFlatQuadStream(
          JellyOptions.DEFAULT_SUPPORTED_OPTIONS.clone.setLogicalType(LogicalStreamType.FLAT_QUADS),
        )

      /** Interpret the incoming stream as a flat RDF quad stream from RDF-STaX.
        *
        * This method will not check the logical stream type of the incoming stream. Use
        * .asFlatQuadStreamStrict if you want to check this.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asFlatQuadStream[TNode, TDatatype, TQuad](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as a flat RDF quad stream from RDF-STaX.
        ...
        *   Pekko Streams flow
        */
      def asFlatQuadStream[TNode, TDatatype, TQuad](supportedOptions: RdfStreamOptions)(using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
    ...
    trait GraphStream:
      /** Interpret the incoming stream as an RDF graph stream from RDF-STaX. Each iterable (graph)
        * in the output stream corresponds to one incoming [[RdfStreamFrame]].
        *
        * The incoming stream must have its logical type set to GRAPHS or its subtype, otherwise the
        * decoding will fail. To allow for any logical type, use .asGraphStream.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asGraphStreamStrict[TNode, TDatatype, TTriple](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as an RDF graph stream from RDF-STaX. Each iterable (graph)
        ...
        *
        * This method will not check the logical stream type of the incoming stream. Use
        * .asGraphStreamStrict if you want to check this.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asGraphStream[TNode, TDatatype, TTriple](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as an RDF graph stream from RDF-STaX. Each iterable (graph)
        ...
        *   Pekko Streams flow
        */
      def asGraphStream[TNode, TDatatype, TTriple](supportedOptions: RdfStreamOptions)(using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
    ...
    trait DatasetStreamOfQuads:
      /** Interpret the incoming stream as an RDF dataset stream from RDF-STaX. Each iterable
        * (dataset) in the output stream corresponds to one incoming [[RdfStreamFrame]]. The dataset
        * is represented as a sequence of quads.
        *
        * The incoming stream must have its logical type set to DATASETS or its subtype, otherwise
        * the decoding will fail. To allow for any logical type, use .asDatasetStreamOfQuads.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asDatasetStreamOfQuadsStrict[TNode, TDatatype, TQuad](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as an RDF dataset stream from RDF-STaX. Each iterable
        ...
        *
        * This method will not check the logical stream type of the incoming stream. Use
        * .asDatasetStreamOfQuadsStrict if you want to check this.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asDatasetStreamOfQuads[TNode, TDatatype, TQuad](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as an RDF dataset stream from RDF-STaX. Each iterable
        ...
        *   Pekko Streams flow
        */
      def asDatasetStreamOfQuads[TNode, TDatatype, TQuad](supportedOptions: RdfStreamOptions)(using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
    ...
    trait DatasetStream:
      /** Interpret the incoming stream as an RDF dataset stream from RDF-STaX. Each iterable
        * (dataset) in the output stream corresponds to one incoming [[RdfStreamFrame]]. The dataset
        * is represented as a sequence of triples grouped by the graph node.
        *
        * The incoming stream must have its logical type set to DATASETS or its subtype, otherwise
        * the decoding will fail. To allow for any logical type, use .asDatasetStream.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asDatasetStreamStrict[TNode, TDatatype, TTriple](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as an RDF dataset stream from RDF-STaX. Each iterable
        ...
        *
        * This method will not check the logical stream type of the incoming stream. Use
        * .asDatasetStreamStrict if you want to check this.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asDatasetStream[TNode, TDatatype, TTriple](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as an RDF dataset stream from RDF-STaX. Each iterable
        ...
        *   Pekko Streams flow
        */
      def asDatasetStream[TNode, TDatatype, TTriple](supportedOptions: RdfStreamOptions)(using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as an RDF dataset stream from RDF-STaX and then flatten it.
        ...
        * node. The dataset is represented as a sequence of triples grouped by the graph node.
        *
        ...
        *   Pekko Streams flow
        */
      final def asNamedGraphStreamStrict[TNode, TDatatype, TTriple](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as an RDF dataset stream from RDF-STaX and then flatten it.
        ...
        *
        * This method will not check the logical stream type of the incoming stream. Use
        * .asNamedGraphStreamStrict if you want to check this.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asNamedGraphStream[TNode, TDatatype, TTriple](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as an RDF dataset stream from RDF-STaX and then flatten it.
        ...
        *   Pekko Streams flow
        */
      def asNamedGraphStream[TNode, TDatatype, TTriple](supportedOptions: RdfStreamOptions)(using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
    ...
    trait AnyStream:
      ...
      /** Interpret the incoming stream as any grouped RDF stream from RDF-STaX. The type of RDF
        ...
        * header. The stream must have a set physical type (UNSPECIFIED is not allowed) and the
        * physical type must not change during the stream.
        *
        * @param converterFactory
        *   Implementation of [[ConverterFactory]] (e.g., JenaConverterFactory).
        * @tparam TNode
        ...
        *   Pekko Streams flow
        */
      final def asGroupedStream[TNode, TDatatype, TTriple, TQuad](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as any flat RDF stream from RDF-STaX. The type of RDF
        ...
        *   Pekko Streams flow
        */
      final def asFlatStream[TNode, TDatatype, TTriple, TQuad](using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
      ...
      /** Interpret the incoming stream as any flat RDF stream from RDF-STaX. The type of RDF
        ...
        *   Pekko Streams flow
        */
      def asFlatStream[TNode, TDatatype, TTriple, TQuad](supportedOptions: RdfStreamOptions)(using
          converterFactory: JellyConverterFactory[
            TNode,
            TDatatype,
            ?,
