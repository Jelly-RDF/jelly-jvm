...
public final class RdfTriple extends ProtoMessage<RdfTriple> implements Cloneable, SpoBase {
    ...
    public boolean equals(Object o) {
        ...
        return (
            subjectNumber == other.subjectNumber &&
            (subjectNumber == 0 || subject.equals(other.subject)) &&
            predicateNumber == other.predicateNumber &&
            (predicateNumber == 0 || predicate.equals(other.predicate)) &&
            objectNumber == other.objectNumber &&
            (objectNumber == 0 || object.equals(other.object))
        );
    }
