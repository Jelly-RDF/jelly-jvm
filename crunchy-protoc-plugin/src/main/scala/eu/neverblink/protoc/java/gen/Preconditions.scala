...
object Preconditions:
  /** Ensures the truth of an expression involving one or more parameters to the calling method.
    ...
    *   if <pre>expression</pre> is false
    */
  ...
  /** Ensures the truth of an expression involving one or more parameters to the calling method.
    ...
    *   replacing each <pre>%s</pre> placeholder in the template with an argument. These are matched
    *   by position - the first <pre>%s</pre> gets <pre>errorMessageArgs[0]</pre>, etc. Unmatched
    *   arguments will be appended to the formatted message in square braces. Unmatched placeholders
    *   will be left as-is.
    * @throws IllegalArgumentException
    *   if <pre>expression</pre> is false
    * @throws NullPointerException
    *   if the check fails and either <pre>errorMessageTemplate</pre> or <pre>errorMessageArgs</pre>
    *   is null (don't let this happen)
    */
  def checkArgument(
      expression: Boolean,
      errorMessageTemplate: String,
      errorMessageArgs: AnyRef*,
  ): Unit =
    if (!expression)
  ...
  /** Ensures that <pre>index</pre> specifies a valid <i>element</i> in an array, list or string of
    * size <pre>size</pre>. An element index may range from zero, inclusive, to <pre>size</pre>,
    * exclusive.
    *
    * @param index
    ...
    * @return
    *   the value of <pre>index</pre>
    * @throws IndexOutOfBoundsException
    *   if <pre>index</pre> is negative or is not less than <pre>size</pre>
    * @throws IllegalArgumentException
    *   if <pre>size</pre> is negative
    */
  /*
  ...
  /** Ensures that <pre>index</pre> specifies a valid <i>position</i> in an array, list or string of
    ...
    *   the value of <pre>index</pre>
    * @throws IndexOutOfBoundsException
    *   if <pre>index</pre> is negative or is greater than <pre>size</pre>
    * @throws IllegalArgumentException
    *   if <pre>size</pre> is negative
    */
  ...
  private def badPositionIndex(index: Int, size: Int, desc: String) = if (index < 0)
  ...
  /** Ensures that <pre>start</pre> and <pre>end</pre> specify a valid <i>positions</i> in an array,
    * list or string of size <pre>size</pre>, and are in order. A position index may range from zero
    * to <pre>size</pre>, inclusive.
    *
    * @param start
    ...
    *   the size of that array, list or string
    * @throws IndexOutOfBoundsException
    *   if either index is negative or is greater than <pre>size</pre> , or if <pre>end</pre> is
    *   less than <pre>start</pre>
    * @throws IllegalArgumentException
    *   if <pre>size</pre> is negative
    */
  ...
  /** Substitutes each <pre>%s</pre> in <pre>template</pre> with an argument. These are matched by
    * position: the first <pre>%s</pre> gets <pre>args[0]</pre>, etc. If there are more arguments
    * than placeholders, the unmatched arguments will be appended to the end of the formatted
    * message in square braces.
    *
    * @param template
    *   a non-null string containing 0 or more <pre>%s</pre> placeholders.
    * @param args
    *   the arguments to be substituted into the message template. Arguments are converted to
    *   strings using [[String# valueOf ( Object )]]. Arguments can be null.
    */
