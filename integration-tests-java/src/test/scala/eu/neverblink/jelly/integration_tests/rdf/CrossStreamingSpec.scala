...
//    ("small, no prefix table", JellyOptions.SMALL_GENERALIZED.setMaxPrefixTableSize(0)),
//    (
//      "tiny name table, no prefix table",
//      JellyOptions.SMALL_GENERALIZED.setMaxPrefixTableSize(0).setMaxNameTableSize(16)
//    ),
