...
lazy val neo4jPlugin = (project in file("neo4j-plugin"))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.neo4j.driver" % "neo4j-java-driver" % "6.0.2" % Test,
    ),
    commonSettings,
    commonJavaSettings,
  )
